...
class AddressBookScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<Map<String, String>> addresses = [
      {'name': 'HOME BASE', 'location': 'House 12, Block A, Gulberg III, Lahore', 'isDefault': 'true', 'icon': 'base'},
      {'name': 'WORK NODE', 'location': 'Penta Square, Phase 5 DHA, Lahore', 'isDefault': 'false', 'icon': 'node'},
      {'name': "RESERVE HUB", 'location': 'Street 4, Sector Z, Phase 6 DHA, Lahore', 'isDefault': 'false', 'icon': 'hub'},
    ];
        ...
        children: [
          ...
          ListView.builder(
            ...
            itemBuilder: (context, i) {
              ...
              final isDefault = addr['location'] == appState.deliveryAddress;
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        if (!isDefault)
                          ElevatedButton(
                            onPressed: () => appState.updateDeliveryAddress(addr['location']!),
